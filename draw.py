...
def draw(img, corners, imgpts, ret):
    ...
    point3 = [int((corner11[0]-(corner[0]-imgpts2[0])*1/3)), int(corner11[1]-(corner[1]-imgpts2[1])*1/3)]
    point4 = [int((corner10[0]-(corner[0]-imgpts2[0])*1/3)), int(corner10[1]-(corner[1]-imgpts2[1])*1/3)]
...
# read the image that will be drawn a box on
